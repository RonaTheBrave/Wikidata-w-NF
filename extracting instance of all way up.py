...
# Get the "instance of" hierarchy for each Wikidata item with progress bar and time estimation
...
df['instance_of_hierarchy'] = results

# Save the result to a new Excel file
output_file_path = 'all_parent_instance_of.xlsx'
